          ...
          <header id="header">
            <Navbar bg="light" expand="lg">
                ...
                navbarScroll>
                    ...
                    <NavDropdown title={<IoMdNotificationsOutline />} id="navbarScrollingDropdown" className="col-md-4">
                    </NavDropdown>
                    <Nav.Link href="#action2" className="col-md-4"><FaShoppingCart />Cart</Nav.Link>
                </Nav>
                </Navbar.Collapse>
            </Navbar>
          </header>
